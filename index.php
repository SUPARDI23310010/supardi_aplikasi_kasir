...
$pesanan = mysqli_query($koneksi,"SELECT * FROM pesanan a,pelanggan b WHERE a.id_pelanggan = b.id_pelanggan");
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <?php $i=1?>
                                        ...
                                        <tr>
                                            ...
                                            <td>Jumlah</td>
                                            <td><a href="view.php?idp=<?= $psn['id_pesanan'];?>" class="btn btn-primary" target="blank" >Tampilkan</a> | Delete</td>
                                        </tr>
                                        <?php $i++; ?>
                                        <?php endforeach ?>
                                    </tbody>
